<?php
// models/User.php
$pdo = require_once '../config/database.php'; // ✅ ini bener, asal database.php return $pdo
$this->pdo = $pdo;

// TAPI! tambahin safety check:
if (!$this->pdo) {
    throw new Exception("❌ Database connection is broken! Check config/database.php");
}
class User
{
    private $pdo;
