...
<body>
    ...
    <form action="../../controllers/AuthController.php" method="post">
        ...
        <select name="login_as" id="login_as" required>
            ...
            <option value="pelanggan" <?php if($loginAs === 'pelanggan') echo 'selected'; ?>>Customer (Email)</option>
            <option value="teknisi" <?php if($loginAs === 'teknisi') echo 'selected'; ?>>Technician (Email)</option>
        </select><br><br>
